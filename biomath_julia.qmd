...
Now that we have activated our environment, we can use the package manager `Pkg.jl` see what packages are installed in the environment and their versions:

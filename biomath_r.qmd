...
### `r icons::icon_style(icons::fontawesome("r-project"),scale=2,fill="steelblue")`
...
[R](https://www.r-project.org/) is a progamming language developed for statistical computing [@baseR]. You can learn more about the history of R [here](https://en.wikipedia.org/wiki/R_(programming_language)). 

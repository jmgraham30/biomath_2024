...
x_values <- seq(-0.25, 1.5, by = 0.01)
growth_values <- logistic_growth(x_values)

phase_line_data <- data.frame(x = x_values, f_x = growth_values)

ggplot(phase_line_data, aes(x = x, y = f_x)) +

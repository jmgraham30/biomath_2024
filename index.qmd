...
Work and research in Biomathematics requires students and professionals in the field to make use of computing and digital technology. The primary uses of digital technology in Biomathematics is for producing and importing data, scientific computing, visualization of data and model-based simulations, and preparing written documents to explain scientific results. Students in this course will be expected to make some use of computing and technical writing. Two commonly used technological tools are [R](https://www.r-project.org/) for scientific computing and [$\LaTeX$](https://www.latex-project.org/) for technical writing. This course will emphasize the use of R which can be installed to any platform via the downloads available [here](https://www.r-project.org/). R is best used with the integrative development environment [RStudio](https://posit.co/download/rstudio-desktop/) which can be installed from [here](https://posit.co/download/rstudio-desktop/). Further, RStudio facilitates the integration of code and technical writing in $\LaTeX$ via the [Quarto](https://quarto.org/) system.  The progamming languages [Julia](https://julialang.org/) and [Python](https://www.python.org/) are also commonly used in scientific computing and are also available for free.

The course website contains references pages for scientific computing for Biomathematics using [R](https://www.r-project.org/), [Julia](https://julialang.org/), and [Python](https://www.python.org/).

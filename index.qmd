...
Welcome to MATH 463 *Topics in Biomathematics* for the Spring, 2024 semester! This page contains the syllabus for the course. We begin with a brief description of biomathematics, followed by information about the instructor, course materials, and course policies.
...
* **Spring 2022 MATH 463 Course Page:**  [https://topicsinbiomath.netlify.app/](https://topicsinbiomath.netlify.app/) contains links to course notes and other materials from when the course was taught in Sprign 2022. 
...
The prerequisites for this course is MATH 341 *Differential Equations* and MATH 351 *Linear Algebra*. Specifically, the student is expected to have a solid foundation in calculus, elementary linear algebra, and basic ordinary differential equations (ODEs).
...
As part of the required coursework for *Topics in Biomathematics*, students are required to submit a model report. The goal of this assignment is for students to read, understand, assess, and explain modeling results from a recently published paper in biology or biomathematics. The model report will make up 10% of the course grade. Students must submit at least two drafts of a model report. A model report should be three-five typed pages and prepared using $\LaTeX$ or [R Markdown](https://rmarkdown.rstudio.com/).  The first draft is due March 25 and the final draft is due May 3. A set of guidelines for the model report is posted on the course learning management system.

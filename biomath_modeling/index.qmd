...
5) [Nondimensionalize](https://en.wikipedia.org/wiki/Nondimensionalization) the model. This is a process founded on the [Buckinghma $\pi$ theorem](https://en.wikipedia.org/wiki/Buckingham_%CF%80_theorem) in which variables and parameters are rescaled to remove units. This process is extremely important as it often simplifies the model by reducing the number of parameters and pinpoints the most significant parameters (or parameter combinations) in the model.
